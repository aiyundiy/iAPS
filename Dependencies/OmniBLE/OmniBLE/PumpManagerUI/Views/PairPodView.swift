...
struct PairPodView: View {
    ...
    var body: some View {
            ...
            VStack {
                ...
                HStack {
                    InstructionList(instructions: [
                        LocalizedString("用U-100胰岛素填充新的Pod（留下蓝色Pod针盖）。", comment: "Label text for step 1 of pair pod instructions"),
        ...
        .navigationBarTitle(LocalizedString("配对Pod", comment: "Pair Pod navigationBarTitle"), displayMode: .automatic)
