    ...
    final class StateModel: BaseStateModel<Provider>, PreferencesSettable { private(set) var preferences = Preferences()
        ...
        override func subscribe() {
            ...
            let mainFields = [
                ...
                Field(
                    displayName: NSLocalizedString("最大每日安全乘数", comment: "Max Daily Safety Multiplier"),
                ...
                Field(
                    displayName: NSLocalizedString("当前的基础安全乘数", comment: "Current Basal Safety Multiplier"),
                ...
                Field(
                    displayName: NSLocalizedString("自动调整胰岛素敏感性的上限值", comment: "Autosens Max"),
            ...
            let smbFields = [
                Field(
                    displayName: NSLocalizedString("始终启用SMB", comment: "Enable SMB Always"),
                ...
                Field(
                    displayName: NSLocalizedString("最大Delta-BG阈值SMB", comment: "Max Delta-BG Threshold"),
                ...
                Field(
                    displayName: NSLocalizedString("用COB启用SMB", comment: "Enable SMB With COB"),
                ...
                Field(
                    displayName: NSLocalizedString("用Temptarget启用SMB", comment: "Enable SMB With Temptarget"),
                ...
                Field(
                    displayName: NSLocalizedString("在碳水化合物后启用SMB", comment: "Enable SMB After Carbs"),
                ...
                Field(
                    displayName: NSLocalizedString("使用高BG启用SMB", comment: "Enable SMB With High BG"),
                ...
                Field(
                    displayName: NSLocalizedString("启用UAM", comment: "Enable UAM"),
                ...
                Field(
                    displayName: NSLocalizedString("最大SMB基础分钟", comment: "Max SMB Basal Minutes"),
                ...
                Field(
                    displayName: NSLocalizedString("最大UAM SMB基础分钟", comment: "Max UAM SMB Basal Minutes"),
                ...
                Field(
                    displayName: NSLocalizedString("SMB送货", comment: "SMB DeliveryRatio"),
                ...
                Field(
                    displayName: NSLocalizedString("SMB间隔", comment: "SMB Interval"),
                ...
                Field(
                    displayName: NSLocalizedString("推注增加", comment: "Bolus Increment"),
            ...
            let targetSettings = [
                ...
                Field(
                    displayName: NSLocalizedString("灵敏度提高了目标", comment: "Sensitivity Raises Target"),
                ...
                Field(
                    displayName: NSLocalizedString("电阻降低目标", comment: "Resistance Lowers Target"),
                ...
                Field(
                    displayName: NSLocalizedString("一半的基础运动目标", comment: "Half Basal Exercise Target"),
            ...
            let otherSettings = [
                Field(
                    displayName: NSLocalizedString("倒带重置自动敏感性调整", comment: "Rewind Resets Autosens"),
                ...
                Field(
                    displayName: NSLocalizedString("使用自定义高峰时间", comment: "Use Custom Peak Time"),
                ...
                Field(
                    displayName: NSLocalizedString("胰岛素峰值时间", comment: "Insulin Peak Time"),
                ...
                Field(
                    displayName: NSLocalizedString("跳过中性温度", comment: "Skip Neutral Temps"),
                ...
                Field(
                    displayName: NSLocalizedString("如果没有临时", comment: "Unsuspend If No Temp"),
                ...
                Field(
                    displayName: NSLocalizedString("暂停零", comment: "Suspend Zeros IOB"),
                ...
                Field(
                    displayName: NSLocalizedString("最小5m碳酸盐", comment: "Min 5m Carbimpact"),
                ...
                Field(
                    displayName: NSLocalizedString("剩余的碳水化合物分数", comment: "Remaining Carbs Fraction"),
                ...
                Field(
                    displayName: NSLocalizedString("剩余的碳水化合物盖", comment: "Remaining Carbs Cap"),
                ...
                Field(
                    displayName: NSLocalizedString("嘈杂的CGM目标乘数", comment: "Noisy CGM Target Multiplier"),
            ...
            sections = [
                FieldSection(
                    displayName: NSLocalizedString("OpenAPS主设置", comment: "OpenAPS main settings"), fields: mainFields
                ),
                FieldSection(
                    displayName: NSLocalizedString("OpenAPS SMB设置", comment: "OpenAPS SMB settings"),
                    fields: smbFields
                ),
                FieldSection(
                    displayName: NSLocalizedString("OpenAPS目标设置", comment: "OpenAPS targets settings"),
                    fields: targetSettings
                ),
                FieldSection(
                    displayName: NSLocalizedString("打开设置其他设置", comment: "OpenAPS other settings"),
